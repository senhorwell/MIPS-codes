...
msgInicial: .asciiz "| ATIVIDADE LAB 8 - EXE 1 |\n"
...
printMatriz: .asciiz "\n\t[MATRIZ]"
printMatrizCesar: .asciiz "\n\t[MATRIZ COM CODIGO DE CESAR]"
...
cesar_code:
	...
	code_i:
		...
		code_j:
				...
				lw $t2, ($t3) #leitura de M[i][j]
				addi $t2, $t2, 3
				sw $t2, ($t3) #Salva em M[i][j]
			
				addi $t1, $t1, 1 # Incrementa j
				beq $t1, $s2, code_i # Se $t1 = número de colunas, incrementa i
				nop
				j code_j
